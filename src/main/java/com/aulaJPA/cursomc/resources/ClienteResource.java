...
public class ClienteResource {
	...
	public ResponseEntity<List<ClienteDTO>> findAll() {
		...
		List<ClienteDTO> listDTO = list.stream().map(obj -> new ClienteDTO(obj)).collect(Collectors.toList());//Converte a lista para outra
	...
	public ResponseEntity<Page<ClienteDTO>> findPage(
		...
		Page<ClienteDTO> listDTO = list.map(obj -> new ClienteDTO(obj));//Convert cada item da lista para um obj ClienteDTO
		return ResponseEntity.ok().body(listDTO);
	}
}
